...
--
-- Host: 192.168.2.100    Database: ensoul_powerjob
-- ------------------------------------------------------
...
CREATE TABLE `instance_info` (
  ...
  `result` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci COMMENT '执行结果',
  ...
  `additional_data` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci COMMENT '附加信息 (JSON)',
  `gmt_create` datetime NOT NULL COMMENT '创建时间',
  `gmt_modified` datetime NOT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`),
...
CREATE TABLE `job_info` (
  ...
  `job_name` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '任务名称',
  ...
  `tag` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'TAG',
  `log_config` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '日志配置',
...
CREATE TABLE `oms_lock` (
  ...
  `lock_name` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '名称',
...
CREATE TABLE `server_info` (
  ...
  `ip` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '服务器IP地址',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uidx01_server_info` (`ip`),
  KEY `idx01_server_info` (`gmt_modified`)
...
-- Dump completed on 2023-08-17 17:26:53
