...
import org.dromara.social.mapper.SocialSubjectMapper;
...
public class SocialSubjectServiceImpl implements ISocialSubjectService {
    ...
    private LambdaQueryWrapper<SocialSubject> buildQueryWrapper(SocialSubjectBo bo) {
        ...
        lqw.eq(StringUtils.isNotBlank(bo.getSocialCode()), SocialSubject::getSocialCode, bo.getSocialCode());
        lqw.like(StringUtils.isNotBlank(bo.getSocialName()), SocialSubject::getSocialName, bo.getSocialName());
        lqw.eq(StringUtils.isNotBlank(bo.getDescribe()), SocialSubject::getDescribe, bo.getDescribe());
        return lqw;
    }
