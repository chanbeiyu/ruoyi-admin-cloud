...
@AutoMappers({@AutoMapper(target = AppInfo.class, uses = AppExtendMapstructMapper.class), @AutoMapper(target = RemoteAppInfo.class, uses = AppExtendMapstructMapper.class)})
